...
- [comfyanonymous/ComfyUI](https://github.com/comfyanonymous/ComfyUI) 🐍 🏠 - Powerful node-based GUI for Stable Diffusion and other AI models, enabling complex workflow design for image generation, processing, and experimentation
...
- [puppeteer/puppeteer](https://github.com/puppeteer/puppeteer) 📇 🏠 - High-level API to control Chrome/Chromium browsers for automation, testing, and web scraping
- [fastapi/fastapi](https://github.com/fastapi/fastapi) 🐍 ☁️ 🏠 - Modern, fast web framework for building APIs with Python, featuring automatic interactive documentation and high performance
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) 📇 🏠 ☁️ - Extensible, feature-rich, and user-friendly web UI for large language models. Supports local model deployment and provides ChatGPT-like interface with advanced features
